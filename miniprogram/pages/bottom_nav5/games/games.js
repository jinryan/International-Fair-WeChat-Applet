...
Page({
  ...
  onLoad: function (options) {
    this.setData({
      gameArray: app.globalData.gameArray,
    })
    console.log(this.data.gameArray)
  },
  ...
  popup: function(id){
    ...
    this.setData({
      popup_hidden: false,
      popup_name: this.data.gameArray[ind]['name'],
      popup_description: this.data.gameArray[ind]['description'],
      centerX: (this.data.gameArray[ind]['x1'] + this.data.gameArray[ind]['x2'] + this.data.gameArray[ind]['x3'] + this.data.gameArray[ind]['x4'])/4,
      centerY: (this.data.gameArray[ind]['y1'] + this.data.gameArray[ind]['y2'] + this.data.gameArray[ind]['y3'] + this.data.gameArray[ind]['y4'])/4,
      })
      console.log("centerx")
